...
<div className='container-fluid'>
    <div className='row'>
        <div className='col-md-8'>
            <h3 style={{marginLeft:"40%"}}>{league} Stats</h3>   
            <LeagueCharts data={data} colors={colors}/>
        </div>
        <div className='col-md-4'>
        <h3 style={{marginLeft:"55%"}}>Standings</h3>
           <TeamsTable teams={teams} league={league} champions={champions}  europa={europa}  conference={conference} regelated={regelated}/>
        </div>
    </div>
</div>
<Bottom/>
